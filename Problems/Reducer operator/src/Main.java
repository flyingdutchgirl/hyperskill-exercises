...
class CustomReducer {
    ...
    public static final BiFunction<Integer, IntBinaryOperator, IntBinaryOperator> reduceIntOperator =
            (seed, operator) -> (a, b) -> IntStream.rangeClosed(a, b).reduce(seed, operator);
     ...
     */
    public static final IntBinaryOperator productOperator = reduceIntOperator.apply(1, (c, d) -> c * d);
